-- ============================================================
-- SEED: Datos Dforzze → Neon PostgreSQL
-- Pegá todo esto en: neon.tech → SQL Editor → Run
-- ============================================================
...
-- 2. USUARIO (contraseña: dforzze2026)
INSERT INTO "User" (id, email, name, password, role, "businessId", "createdAt", "updatedAt")
VALUES ('usr_dforzze_owner', 'admin@dforzze.com', 'Dforzze Admin', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lHuu', 'owner', 'cmqb80war0018q6bvjmnll1np', NOW(), NOW())
